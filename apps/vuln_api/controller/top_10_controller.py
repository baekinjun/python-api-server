...
from apps.vuln_api.service import Top10VulnService
...
class TodayOutageView(Resource):
    def __init__(self):
        self.vuln_service = Top10VulnService()
    ...
    def get(self):
        ...
        res = self.vuln_service.top_10_outage(now)
